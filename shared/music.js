...
const albumConfigs = [
...

  {
    ...
    tracks: [
      ...
      { title: "Mall (Stealth) - Escalator Loop 6A", src: "audio/1 - Escalator Loop 6A.mp3" },
      { title: "Mall (Stealth) - Gray Corridor Systems, pt. I", src: "audio/2 - Gray Corridor Systems.mp3" },
      { title: "Mall (Skirmish) - Gray Corridor Systems, pt. II", src: "audio/3 - Gray Corridor Systems 2.mp3" },
      { title: "Mall (Skirmish) - Barricade Protocol", src: "audio/4 - Barricade Protocol.mp3" },
      { title: "Mall (Combo) - Black Glass Slogan, pt. I", src: "audio/5 - Black Glass Slogan.mp3" },
      { title: "Mall (Combo) - Black Glass Slogan, pt. II", src: "audio/6 - Black Glass Slogan 2.mp3" },
      { title: "Mall (Boss) - Pressure Cycle", src: "audio/7 - Pressure Cycle.mp3" },
      { title: "Mall (Boss) - Pressure Discipline", src: "audio/8 - Pressure Discipline.mp3" },
